...
_This document provides a comprehensive overview of all AXorcist classes and their usage patterns. For interactive API documentation, run `../view-docs.sh` to open the DocC archives._
...
```json
{
  "criteria": [{ "attribute": "domclasslist", "value": "btn-primary", "match_type": "contains" }]
}
```
