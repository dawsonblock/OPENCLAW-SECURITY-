...
| `list-all`    | Snapshot the frontmost app’s full menu tree _and_ all system menu extras in one go.              | `--include-disabled`, `--include-frames` (adds pixel coordinates for extras).                                                                                                    |
