...
#endif /_ CGS_ACCESSIBILITY_INTERNAL_H _/
...
#endif /_ CGS_CIFILTER_INTERNAL_H _/
...
#endif /_ CGS_CONNECTION_INTERNAL_H _/
...
#endif /_ CGS_CURSOR_INTERNAL_H _/
...
#endif /_ CGS_DEBUG_INTERNAL_H _/
...
#endif /_ CGS_DISPLAYS_INTERNAL_H _/
...
typedef unsigned long long CGSEventRecordTime; /_ nanosecond timer _/
...
CGSEventRecordVersion major; /_0x0_/
CGSEventRecordVersion minor; /_0x2_/
CGSByteCount length; /_0x4_/ /_ Length of complete event record _/
CGSEventType type; /_0x8_/ /_ An event type from above _/
CGPoint location; /_0x10_/ /_ Base coordinates (global), from upper-left _/
CGPoint windowLocation; /_0x20_/ /_ Coordinates relative to window _/
CGSEventRecordTime time; /_0x30_/ /_ nanoseconds since startup _/
CGSEventFlag flags; /_ key state flags _/
CGWindowID window; /_ window number of assigned window _/
CGSConnectionID connection; /_ connection the event came from _/
struct \_\_CGEventSourceData {
int source;
...
#endif /_ CGS_EVENT_INTERNAL_H _/
...
#endif /_ CGS_HOTKEYS_INTERNAL_H _/
...
#endif /_ CGS_REGION_INTERNAL_H _/
...
#endif /_ CGS_SESSION_INTERNAL_H _/
...
#endif /_ CGS_SURFACE_INTERNAL_H _/
...
CGWindowID wid; /_ 0 means a full screen transition. _/
CGFloat _backColor; /_ NULL means black. */
...
#endif /_ CGS_TRANSITIONS_INTERNAL_H _/
...
#define kCGSRealMaximumTagSize (sizeof(void _) _ 8)
...
typedef enum {
kCGSOrderBelow = -1,
kCGSOrderOut, /_ hides the window _/
kCGSOrderAbove,
kCGSOrderIn /_ shows the window _/
...
#endif /_ CGS_WINDOW_INTERNAL_H _/
