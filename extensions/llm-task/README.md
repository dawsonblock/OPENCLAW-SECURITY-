...
`openclaw.invoke --each`) without adding new AetherBot code per workflow.
...
This extension depends on AetherBot internal modules (the embedded agent runner).
It is intended to ship as a **bundled** AetherBot extension (like `lobster`) and
