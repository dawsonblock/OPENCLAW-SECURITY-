...
import type { ExecApprovalsFile, ExecHost } from "../infra/exec-approvals.js";
import {
  addAllowlistEntry,
...
import { DEFAULT_DANGEROUS_BUDGET } from "../security/exec-budgets.js";
import { SAFE_ENV_KEYS } from "../security/exec-env-allowlist.js";
import { markBackgrounded, tail } from "./bash-process-registry.js";
import { createApprovalSlug, emitExecSystemEvent, resolveApprovalRunningNoticeMs } from "./bash-tools.exec.events.js";
import {
  normalizeExecAsk,
  normalizeExecHost,
  ...
  applyPathPrepend,
  applyShellPath,
} from "./bash-tools.exec.normalize.js";
import { DEFAULT_PATH, validateHostEnv } from "./bash-tools.exec.policy.js";
import { buildNodeInvokeIdempotencyKey, buildWarningText } from "./bash-tools.exec.request.js";
import { runExecProcess } from "./bash-tools.exec.runtime.js";
export type { ExecElevatedDefaults, ExecToolDefaults, ExecToolDetails } from "./bash-tools.exec.types.js";
import type { ExecProcessHandle, ExecToolDefaults, ExecToolDetails } from "./bash-tools.exec.types.js";
import {
...
export function createExecTool(
  ...
  return {
    ...
    execute: async (_toolCallId, args, signal, onUpdate) => {
      ...
      if (host === "node") {
        ...
        const buildInvokeParams = (
          ...
          ({
            ...
            idempotencyKey: buildNodeInvokeIdempotencyKey(),
        ...
        if (requiresAsk) {
          ...
          const warningText = buildWarningText(warnings);
      ...
      const getWarningText = () => buildWarningText(warnings);
