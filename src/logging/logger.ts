...
export const DEFAULT_LOG_DIR = "/tmp/aetherbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "aetherbot.log"); // legacy single-file path

const LOG_PREFIX = "aetherbot";
