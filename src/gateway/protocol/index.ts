...
import {
  ...
  type CapabilityApprovalRequestParams,
  CapabilityApprovalRequestParamsSchema,
  ErrorCodes,
  type ErrorShape,
  ErrorShapeSchema,
  type EventFrame,
...
export const validateCapabilityApprovalRequestParams = ajv.compile<CapabilityApprovalRequestParams>(
  CapabilityApprovalRequestParamsSchema,
);
