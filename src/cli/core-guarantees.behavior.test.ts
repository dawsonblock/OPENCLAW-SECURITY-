...
/**
 * Fast behavior checks for core security and health helpers.
 *
 * These are intentionally mock-heavy and complement the smaller runtime smoke
 * coverage in `src/runtime/runtime-truth.smoke.test.ts`.
 */
