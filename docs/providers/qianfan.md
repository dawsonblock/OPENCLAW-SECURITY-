---
summary: "Use Qianfan's unified API to access many models in AetherBot"
read_when:
...
3. AetherBot installed on your system
...
4. Copy the API key for use with AetherBot

## CLI setup

```bash
aetherbot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AetherBot Configuration](/gateway/configuration)
