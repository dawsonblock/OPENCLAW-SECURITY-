---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AetherBot"
read_when:
  - You want Xiaomi MiMo models in AetherBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AetherBot uses
...
```bash
aetherbot onboard --auth-choice xiaomi-api-key
# or non-interactive
aetherbot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
