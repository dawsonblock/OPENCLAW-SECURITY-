---
summary: "Use Qwen OAuth (free tier) in AetherBot"
read_when:
  - You want to use Qwen with AetherBot
...
```bash
aetherbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, AetherBot will sync credentials
