...
You can point AetherBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AetherBot
...
- [Anthropic provider](/providers/anthropic) - Native AetherBot integration with Claude setup-token or API keys
