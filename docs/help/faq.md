---
summary: "Frequently asked questions about AetherBot setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up AetherBot?](#whats-the-recommended-way-to-install-and-set-up-aetherbot)
  ...
  - [I can't access docs.aetherbot.ai (SSL error). What now?](#i-cant-access-docsaetherbotai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or aetherbot not recognized](#windows-install-says-git-not-found-or-aetherbot-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install AetherBot on Linux?](#how-do-i-install-aetherbot-on-linux)
  - [How do I install AetherBot on a VPS?](#how-do-i-install-aetherbot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask AetherBot to update itself?](#can-i-ask-aetherbot-to-update-itself)
  ...
  - [If I buy a Mac mini to run AetherBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-aetherbot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different AetherBot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-aetherbot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run AetherBot on a dedicated machine?](#how-important-is-it-to-run-aetherbot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run AetherBot in a VM and what are the requirements](#can-i-run-aetherbot-in-a-vm-and-what-are-the-requirements)
- [What is AetherBot?](#what-is-aetherbot)
  - [What is AetherBot, in one paragraph?](#what-is-aetherbot-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for AetherBot](#what-are-the-top-five-everyday-use-cases-for-aetherbot)
  - [Can AetherBot help with lead gen outreach ads and blogs for a SaaS](#can-aetherbot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can AetherBot run tasks on a schedule or continuously in the background?](#can-aetherbot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with AetherBot saved locally?](#is-all-data-used-with-aetherbot-saved-locally)
  - [Where does AetherBot store its data?](#where-does-aetherbot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall AetherBot?](#how-do-i-completely-uninstall-aetherbot)
...
- [Config basics](#config-basics)
  ...
  - [Can the AetherBot browser run headless?](#can-the-aetherbot-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two AetherBot instances talk to each other (local + VPS)?](#can-two-aetherbot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does AetherBot load environment variables?](#how-does-aetherbot-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of AetherBot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-aetherbot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset AetherBot but keep it installed?](#how-do-i-completely-reset-aetherbot-but-keep-it-installed)
  ...
  - [Why doesn't AetherBot reply in a group?](#why-doesnt-aetherbot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do AetherBot, Flawd, and Krill use for models?](#what-do-aetherbot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `aetherbot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-aetherbot-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `aetherbot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-aetherbot-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run AetherBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-aetherbot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart AetherBot?](#i-closed-my-terminal-on-windows-how-do-i-restart-aetherbot)
  ...
  - [ELI5: `aetherbot gateway restart` vs `aetherbot gateway`](#eli5-openclaw-gateway-restart-vs-aetherbot-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose AetherBot to inbound DMs?](#is-it-safe-to-expose-aetherbot-to-inbound-dms)
...
7. **Gateway snapshot**
   ...
   aetherbot health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://aetherbot.ai/install.sh | bash -s -- --install-method git
```

This installs AetherBot **from a git checkout**, so the agent can read the code + docs and
...
```bash
aetherbot status
aetherbot models status
aetherbot doctor
```

What they do:

- `aetherbot status`: quick snapshot of gateway/agent health + basic config.
- `aetherbot models status`: checks provider auth + model availability.
- `aetherbot doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `aetherbot status --all`, `aetherbot logs --follow`,
`aetherbot gateway status`, `aetherbot health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up AetherBot
...
If you don't have a global install yet, run it via `pnpm aetherbot onboard`.
...
- Retrieve it from the gateway host: `aetherbot config get gateway.auth.token` (or generate one: `aetherbot doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `aetherbot gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `aetherbot gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install AetherBot on the new machine.
2. Copy `$OPENCLAW_STATE_DIR` (default: `~/.aetherbot`) from the old machine.
3. Copy your workspace (default: `~/.openclaw/workspace`).
4. Run `aetherbot doctor` and restart the Gateway service.
...
Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-aetherbot-store-its-data),
...
### I cant access docs.aetherbot.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.aetherbot.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.aetherbot.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsaetherbotai-shows-an-ssl-error-comcastxfinity).
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://aetherbot.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://aetherbot.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://aetherbot.ai/install.ps1](https://aetherbot.ai/install.ps1)
...
```bash
curl -fsSL https://aetherbot.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://aetherbot.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://aetherbot.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or aetherbot not recognized
...
**2) aetherbot is not recognized after install**
...
### How do I install AetherBot on Linux
...
### How do I install AetherBot on a VPS
...
### Can I ask AetherBot to update itself
...
```bash
aetherbot update
aetherbot update status
aetherbot update --channel stable|beta|dev
aetherbot update --tag <dist-tag|version>
aetherbot update --no-restart
```

If you must automate from an agent:

```bash
aetherbot update --yes --no-restart
aetherbot gateway restart
```
...
`aetherbot onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run AetherBot with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `aetherbot models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `aetherbot models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `aetherbot models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. AetherBot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so AetherBot can keep replying while a provider is rate-limited.
...
AetherBot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. AetherBot fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
1. Enable the plugin: `aetherbot plugins enable google-gemini-cli-auth`
2. Login: `aetherbot models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. AetherBot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. AetherBot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run AetherBot can I connect it to my MacBook Pro
...
- Use `aetherbot nodes status` / `aetherbot nodes list` to see it.
...
- DM your bot, then run `aetherbot logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different AetherBot instances
...
If you run AetherBot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the AetherBot code install. Your state
(`~/.aetherbot`) and workspace (`~/.openclaw/workspace`) stay untouched.
...
**AetherBot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run AetherBot on a dedicated machine
...
AetherBot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run AetherBot in a VM and what are the requirements
...
### What is AetherBot in one paragraph

AetherBot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

AetherBot is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for AetherBot
...
### Can AetherBot help with lead gen outreach ads and blogs for a SaaS
...
AetherBot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

AetherBot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use AetherBot when you
...
Showcase: [https://aetherbot.ai/showcase](https://aetherbot.ai/showcase)
...
Yes. Add extra directories via `skills.load.extraDirs` in `~/.openclaw/openclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.openclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which AetherBot treats as `<workspace>/skills`.
...
```bash
aetherbot cron run <jobId> --force
...
### Can AetherBot run tasks on a schedule or continuously in the background
...
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-aetherbot-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. AetherBot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured AetherBot workspace); AetherBot treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.openclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
AetherBot memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

AetherBot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, AetherBot auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, AetherBot
prefers `local`.
...
### Is all data used with AetherBot saved locally

No - **AetherBot's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.aetherbot` + your workspace directory).
...
### Where does AetherBot store its data

Everything lives under `$OPENCLAW_STATE_DIR` (default: `~/.aetherbot`):
...
Legacy single-agent path: `~/.openclaw/agent/*` (migrated by `aetherbot doctor`).
...
These files live in the **agent workspace**, not `~/.aetherbot`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.aetherbot`)**: config, credentials, auth profiles, sessions, logs,
...
Do **not** commit anything under `~/.aetherbot` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall AetherBot
...
`workspace` to the repo root. The AetherBot repo is just source code; keep the
...
AetherBot reads an optional **JSON5** config from `$OPENCLAW_CONFIG_PATH` (default: `~/.openclaw/openclaw.json`):
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `aetherbot doctor --generate-gateway-token`.
...
key. **Recommended:** run `aetherbot configure --section web` to store it in
...
### Can the AetherBot browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   aetherbot nodes pending
   aetherbot nodes approve <requestId>
   ```
...
- Gateway is running: `aetherbot gateway status`
- Gateway health: `aetherbot status`
- Channel health: `aetherbot channels status`
...
### Can two AetherBot instances talk to each other local VPS
...
`aetherbot agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
aetherbot agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- If you have no backup, re-run `aetherbot doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `aetherbot config set` for small changes.
- Use `aetherbot configure` for interactive edits.
...
```bash
aetherbot gateway --tailscale serve
```
...
### How does AetherBot load environment variables

AetherBot reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:
...
`aetherbot models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means AetherBot won't load
...
### Is there a way to make a team of AetherBot instances one CEO and many agents
...
### How do I completely reset AetherBot but keep it installed
...
```bash
aetherbot reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `OPENCLAW_PROFILE`), reset each state dir (defaults are `~/.aetherbot-<profile>`).
- Dev reset: `aetherbot gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), AetherBot skips the heartbeat run to save API calls.
...
No. AetherBot runs on **your own account**, so if you're in the group, AetherBot can see it.
...
```bash
aetherbot directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt AetherBot reply in a group
...
- Use `aetherbot doctor` to spot stray workspaces and profile mismatches.
...
AetherBot's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, AetherBot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `aetherbot models set ...` (updates just model config)
- `aetherbot configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.openclaw/openclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `aetherbot doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do AetherBot, Flawd, and Krill use for models

- **AetherBot + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. AetherBot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run `aetherbot agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so AetherBot can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  ...
  - Legacy: `~/.openclaw/agent/*` (migrated by `aetherbot doctor`)
...
- **Sanity-check model/auth status**
  - Use `aetherbot models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `aetherbot models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `aetherbot models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.openclaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    aetherbot models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), AetherBot will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: AetherBot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
AetherBot uses provider-prefixed IDs like:
...
AetherBot may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `aetherbot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
aetherbot models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
aetherbot models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
aetherbot models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
aetherbot models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

AetherBot supports both:
...
### Why does aetherbot gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `aetherbot gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does aetherbot gateway status show Config cli and Config service different
...
```bash
aetherbot gateway install --force
```
...
AetherBot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `aetherbot gateway --port <port>`.

### How do I run AetherBot in remote mode client connects to a Gateway elsewhere
...
- `aetherbot gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `aetherbot dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `aetherbot doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `OPENCLAW_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `aetherbot status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `aetherbot --profile <name> …` per instance (auto-creates `~/.aetherbot-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `aetherbot --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.openclaw.*`, `openclaw-gateway-<profile>.service`, `AetherBot Gateway (<profile>)`).
...
```
aetherbot tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$OPENCLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.openclaw/logs/...`; profiles use `~/.aetherbot-<profile>/logs/...`)
- Linux: `journalctl --user -u openclaw-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "AetherBot Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `aetherbot gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart AetherBot
...
1. Is the Gateway running? `aetherbot gateway status`
2. Is the Gateway healthy? `aetherbot status`
3. Does the UI have the right token? `aetherbot dashboard`
...
```bash
aetherbot channels status
aetherbot channels logs --channel telegram
```
...
### ELI5 aetherbot gateway restart vs aetherbot gateway

- `aetherbot gateway restart`: restarts the **background service** (launchd/systemd).
- `aetherbot gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `aetherbot gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [AetherBot assistant setup](/start/openclaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
aetherbot message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose AetherBot to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `aetherbot pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `aetherbot pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `aetherbot doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. AetherBot only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
aetherbot pairing approve whatsapp <code>
```

List pending requests:

```bash
aetherbot pairing list whatsapp
```
...
AetherBot blocks **cross-provider** messaging by default. If a tool call is bound
