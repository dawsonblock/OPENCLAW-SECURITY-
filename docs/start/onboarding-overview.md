---
summary: "Overview of AetherBot onboarding options and flows"
read_when:
...
AetherBot supports multiple onboarding paths depending on where the Gateway runs
...
- [`aetherbot onboard` command](/cli/onboard)

## macOS app onboarding

Use the AetherBot app when you want a fully guided setup on macOS. Docs:
