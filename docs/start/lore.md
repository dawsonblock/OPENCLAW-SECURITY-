---
summary: "Backstory and lore of AetherBot for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "AetherBot Lore"
---

# The Lore of AetherBot 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **AetherBot**.
...
In the end, **AetherBot** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around AetherBot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then AetherBot): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "aetherbot what did we discuss about talking with people xD"
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at AetherBot" to promote pump-and-dump tokens.
...
**The Great AetherBot Migration** began.
...
- Docs migrated to `docs.aetherbot.ai`
