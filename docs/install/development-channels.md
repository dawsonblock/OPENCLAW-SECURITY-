...
AetherBot ships three update channels:
...
When you **explicitly** switch channels with `--channel`, AetherBot also aligns
the install method:
...
When you switch channels with `aetherbot update`, AetherBot also syncs plugin sources:
