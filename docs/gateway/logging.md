...
AetherBot has two log “surfaces”:
...
`aetherbot gateway` supports a per-gateway style switch:
...
aetherbot gateway --verbose --ws-log compact

# show all WS traffic (full meta)
aetherbot gateway --verbose --ws-log full
```
