...
This guide summarizes a sane workflow for working on the pi integration in AetherBot.
...
- Trigger the agent directly:
  - `pnpm aetherbot agent --message "Hello" --thinking low`
...
State lives under the AetherBot state directory. Default is `~/.aetherbot`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.
...
- [https://docs.aetherbot.ai/testing](https://docs.aetherbot.ai/testing)
- [https://docs.aetherbot.ai/start/getting-started](https://docs.aetherbot.ai/start/getting-started)
