...
read_when:
  - You are building a AetherBot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (aetherbot.plugin.json)

Every plugin **must** ship a `openclaw.plugin.json` file in the **plugin root**.
AetherBot uses this manifest to validate configuration **without executing plugin
