...
aetherbot system heartbeat last
aetherbot logs --follow
aetherbot config get agents.defaults.heartbeat
aetherbot channels status --probe
```
...
```bash
aetherbot config get agents.defaults.heartbeat.activeHours
aetherbot config get agents.defaults.heartbeat.activeHours.timezone
aetherbot config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
aetherbot cron list
aetherbot logs --follow
```
