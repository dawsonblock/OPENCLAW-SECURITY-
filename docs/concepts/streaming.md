...
AetherBot has two separate “streaming” layers:
...
When block streaming is enabled, AetherBot can **merge consecutive block chunks**
...
When draft streaming is active, AetherBot disables block streaming for that reply to avoid double-streaming.
