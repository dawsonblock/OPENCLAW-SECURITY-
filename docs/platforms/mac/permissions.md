...
- Same path: run the app from a fixed location (for AetherBot, `dist/AetherBot.app`).
...
Workaround: move files into the AetherBot workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.
