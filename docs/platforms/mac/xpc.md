---
summary: "macOS IPC architecture for AetherBot app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# AetherBot macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → AetherBot.app → local execution.
