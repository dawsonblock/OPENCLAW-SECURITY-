---
summary: "AetherBot macOS companion app (menu bar + gateway broker)"
read_when:
...
# AetherBot macOS Companion (menu bar + gateway broker)

The macOS app is the **menu‑bar companion** for AetherBot. It owns permissions,
...
- **Local** (default): the app attaches to a running local Gateway if present;
  otherwise it enables the launchd service via `aetherbot gateway install`.
...
1. Install and launch **AetherBot.app**.
...
Tip: compare against `aetherbot gateway discover --json` to see whether the
