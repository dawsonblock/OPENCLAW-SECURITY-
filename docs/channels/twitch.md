...
read_when:
  - Setting up Twitch chat integration for AetherBot
title: "Twitch"
---

# Twitch (plugin)

Twitch chat support via IRC connection. AetherBot connects as a Twitch user (bot account) to receive and send messages in channels.
