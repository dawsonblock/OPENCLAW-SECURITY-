...
- Install via CLI: `aetherbot plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `aetherbot plugins install ./extensions/zalo`
   - From npm (if published): `aetherbot plugins install @openclaw/zalo`
...
- Approve via:
  - `aetherbot pairing list zalo`
  - `aetherbot pairing approve zalo <CODE>`
...
- Example: `aetherbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `aetherbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `aetherbot logs --follow`
