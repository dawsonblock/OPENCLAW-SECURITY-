...
This is the full reference for the `aetherbot onboard` CLI wizard.
...
<Steps>
  <Step title="Existing config detection">
    ...
    - If the config is invalid or contains legacy keys, the wizard stops and asks
      you to run `aetherbot doctor` before continuing.
  ...
  <Step title="Channels">
    ...
    - DM security: default is pairing. First DM sends a code; approve via `aetherbot pairing approve <channel> <code>` or use allowlists.
  </Step>
  ...
  <Step title="Health check">
    - Starts the Gateway (if needed) and runs `aetherbot health`.
    - Tip: `aetherbot status --deep` adds gateway health probes to status output (requires a reachable gateway).
  </Step>
