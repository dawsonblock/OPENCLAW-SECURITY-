...
export OPENCLAW_STATE_DIR="/tmp/aetherbot-test"
export OPENCLAW_CONFIG_PATH="${OPENCLAW_STATE_DIR}/aetherbot.json"
...
pnpm aetherbot reset --scope config+creds+sessions --yes --non-interactive
...
pnpm aetherbot uninstall --state --yes --non-interactive
