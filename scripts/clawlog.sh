...
show_usage() {
    cat << EOF
clawlog - AetherBot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View AetherBot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    AetherBot logs flow through the macOS unified log (subsystem: ai.openclaw).
