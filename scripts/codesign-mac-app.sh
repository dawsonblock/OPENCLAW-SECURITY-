...
ENT_TMP_BASE=$(mktemp -t aetherbot-entitlements-base.XXXXXX)
ENT_TMP_APP_BASE=$(mktemp -t aetherbot-entitlements-app-base.XXXXXX)
ENT_TMP_RUNTIME=$(mktemp -t aetherbot-entitlements-runtime.XXXXXX)
